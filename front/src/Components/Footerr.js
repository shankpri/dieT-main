    ...
    <div className="container py-4 py-lg-5 my-lg-0">
        ...
        <div className="col">
          <div className="card text-dark pricing-card">
            <div className="card-body p-4 px-3 px-lg-4">
              ...
              <p className="text-muted card-text pricing-description">
                We Offer advanced form of our services for customers who want to invest for larger period of time
              </p>
              <div className="d-flex justify-content-end">
                <button
                  className="btn border rounded-circle border-0"
        ...
        <div className="col">
          <div className="card text-dark pricing-card">
            <div className="card-body p-4 px-3 px-lg-4">
              ...
              <h6 className="card-subtitle mb-2">
                <span style={{color: "rgb(32, 33, 36)"}}>Rs-7.99k/month</span>
              </h6>
              <p className="text-muted card-text pricing-description">
               It is the most premeuim type of ervices we can offer for customers
              </p>
              <div className="d-flex justify-content-end">
                <button
                  className="btn border rounded-circle border-0"
      ...
      <div className="row my-5">
        <div className="col text-center">
          ...
          <button className="btn bg-black" type="button">
            Join our community
          </button>
        </div>
      </div>
